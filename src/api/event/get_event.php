...
if ($get_users) {
$member_query = "SELECT member_shift_committee.member_id, member_shift_committee.day_id, shift.shift_number ";
$member_query .= "FROM member_shift_committee INNER JOIN shift ON member_shift_committee.shift_id=";
$member_query .= "shift.shift_id WHERE member_shift_committee.event_id = ?";
...
$member_hash['day_id'] = $member[1];
$member_hash['shiftnumber'] = $member[2];
