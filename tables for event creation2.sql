...
ALTER TABLE eventt_day ADD FOREIGN KEY (event_id) REFERENCES eventt(event_id) ON DELETE CASCADE;
...
ALTER TABLE shift ADD FOREIGN KEY (event_id) REFERENCES eventt(event_id) ON DELETE CASCADE;
...
ALTER TABLE session ADD FOREIGN KEY (event_id) REFERENCES eventt(event_id) ON DELETE CASCADE;
